...
def fetch_player_data(team_id):
    ...
    try:
        ...
        parsed_player_list = parse_teams_data(team_players_list)
...
def fetch_season_games(league_id, season_str):
    try:
        ...
        parsed_season_list = parse_games_data(season_games_list)
...
def fetch_live_scores_data(league_id):
    ...
    try:
        ...
        parsed_live_games = parse_games_data(live_games_list)
